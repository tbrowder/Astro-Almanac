...
C<Astro::Almanac> - Provides data on the paths of the Sun, Moon, and planets
...
C<Astro::Almanac> under the covers uses three fine Perl modules thanks
to the excellent Raku module C<Inline::Perl5>.
