...
C<Astro::Almanac> - Provides data on the paths of the Sun, Moon, and
planets along with some utility functions for astronomical calculations
...
and planets, all output as a JSON file named C<astro-data.json>.
...
excellent aid for amateur astronomers, the Perl module C<Astro::Montenbruck>,
